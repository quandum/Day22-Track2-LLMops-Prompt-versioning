...
PROMPT_V1_NAME = "tran-manh-chanh-quan-rag-v1"
PROMPT_V2_NAME = "tran-manh-chanh-quan-rag-v2"
...
SYSTEM_V1 = (
    ...
    "Giữ câu trả lời ngắn gọn (2-4 câu). Nếu không có thông tin, nói thẳng là không biết."
)
...
SYSTEM_V2 = (
    ...
    "viết câu trả lời rõ ràng và có tổ chức (3-5 câu). "
    "Luôn trích dẫn nguồn từ context và nêu mức độ chắc chắn của câu trả lời."
)
    ...
    for i, question in enumerate(SAMPLE_QUESTIONS):
        ...
        for attempt in range(3):
            try:
                ...
                if attempt < 2:
                    print(f"  ⚠️ Lỗi, thử lại ({attempt+2}/3): {e}")
                    time.sleep(3)
                else:
                    raise
